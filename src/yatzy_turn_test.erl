%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   These tests are courtesy of Stephen Quin   %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
-module(yatzy_turn_test).
...
roll_valid_test() ->
	...
	?assertEqual(ok, yatzy_turn:roll(A, K)),
	...
	?assertEqual(ok, yatzy_turn:roll(A, K1)),
	...
	?assertEqual(ok, yatzy_turn:roll(B, K2)),
	...
	?assertEqual(ok, yatzy_turn:roll(B, K3)),
